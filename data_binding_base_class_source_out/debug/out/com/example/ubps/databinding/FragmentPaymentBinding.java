...
public final class FragmentPaymentBinding implements ViewBinding {
  ...
  private FragmentPaymentBinding(@NonNull LinearLayout rootView, @NonNull ListView listView) {
  ...
  public static FragmentPaymentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentPaymentBinding((LinearLayout) rootView, listView);
    }
