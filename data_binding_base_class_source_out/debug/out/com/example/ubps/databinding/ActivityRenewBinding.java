...
public final class ActivityRenewBinding implements ViewBinding {
  ...
  private ActivityRenewBinding(@NonNull View rootView, @NonNull Button Submit,
  ...
  @NonNull
  public static ActivityRenewBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityRenewBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_renew, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityRenewBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityRenewBinding(rootView, Submit, accept, distance, roostartt, rootstop,
          validity);
    }
